...
void ins_data_to_a()
{
	data_send.start_flag = 's';
	data_send.yaw = angle_1; // 接受yaw轴陀螺仪数据
	
	buffer[0] =  data_send.start_flag;
	buffer[1] = (data_send.yaw >> 8) & 0xff;
	buffer[2] =  data_send.yaw;
