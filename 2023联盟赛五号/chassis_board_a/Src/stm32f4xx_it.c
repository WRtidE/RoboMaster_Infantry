...
/* USER CODE BEGIN EV */
volatile uint8_t rx_len_uart6;  //接收一帧数据的长度
volatile uint8_t recv_end_flag_uart6; //一帧数据接收完成标志
int flagg=0;
/* USER CODE END EV */
...
void USART6_IRQHandler(void)
{
  /* USER CODE BEGIN USART6_IRQn 0 */
	...
	{ 
		...
		//这句和上面那句等效
		rx_len_uart6 =  100 - temp; //总计数减去未传输的数据个数，得到已经接收的数据个数
		recv_end_flag_uart6 = 1;	// 接受完成标志位置1	
	 }
