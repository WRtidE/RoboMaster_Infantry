...
extern void CAN_rc_forward(int16_t ch[], char s[],int32_t ins_yaw, int32_t ins_pitch, int32_t ins_roll,int32_t yaw_data);
extern void CAN_cmd_chassis(int16_t yaw, int16_t pitch, int16_t shoot, int16_t rev);
extern void send_ins_data_to_a(int32_t ins_yaw, int32_t ins_pitch, int32_t ins_roll,int32_t yaw_data);
#endif